...
for kernel_version in %{?kernel_versions}; do
    make %{?_smp_mflags} -C "${kernel_version##*___}" M=${PWD}/hid-logimouse_%{version} modules
done
...
for kernel_version in %{?kernel_versions}; do
    ...
    cp -v hid-logimouse_%{version}/*.ko ${RPM_BUILD_ROOT}%{kmodinstdir_prefix}/${kernel_version%%___*}/%{kmodinstdir_postfix}
done
%{?akmod_install}
